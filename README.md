...
**Zoom app is in Development mode until reviewed.** Only Zoom accounts within the same account/org as whoever built the app can authorize it — anyone else gets bounced back to the Marketplace instead of the consent screen. To open this up: **Beta Test** page in the app dashboard → **Request to Share** (needs the **Technical Design** section filled in first — technology stack, architecture diagram, security questionnaire — Zoom's review team responds in 3-4 business days), or submit for full production review (see "Going to production" below).
